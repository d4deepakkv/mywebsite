...
def chat():
    ...
    conversation_id = data.get('conversation_id', get_conversation_id())
    ...
    try:
        ...
        if len(conversations[conversation_id]) > 21:  # 1 system + 20 messages
...
if __name__ == '__main__':
    ...
    if init_openai():
        ...
        print("WARNING: OpenAI API not initialized. Set OPENAI_API_KEY environment variable.")
